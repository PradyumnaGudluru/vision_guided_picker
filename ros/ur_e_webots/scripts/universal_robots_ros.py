...
"""An extern controller for an universal_robot_ros"""
...
from ur_e_webots.robotiq_3f_gripper import GripperCommander
...
parser.add_argument('--ns', dest='namespace', default='/arm_controller', help='action server namespace')
...
# start an ActionServer of JointTrajectoryFollowerAction
# trajectoryFollower = TrajectoryFollower(robot, jointStatePublisher, jointPrefix, nodeName)
trajectoryFollower = TrajectoryFollower(robot, jointStatePublisher, jointPrefix, arguments.namespace + '/')
trajectoryFollower.start()


# start an ActionServer of GripperCommandAction
gripperCommander = GripperCommander(robot, 'gripper_controller/')
gripperCommander.start()
